...
";
        ...
        // The importer is lenient with malformed/overflow license expiry dates (e.g. "invalid date",
        // "2021-02-30"): they are normalized rather than rejected, so all 7 rows import successfully.
